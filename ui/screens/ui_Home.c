...
void ui_Home_screen_init(void)
{
    ...
    lv_img_set_src(ui_Map_Bg, &ui_img_map_png);
    ...
    lv_obj_clear_flag(ui_Marker_Group, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_clear_flag(ui_GPS_Root2, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_clear_flag(ui_GPS_Root1, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    ui_Gps_Knob_Bg = lv_img_create(ui_Marker_Group);
    lv_img_set_src(ui_Gps_Knob_Bg, &ui_img_gps_knob_png);
    ...
    lv_obj_clear_flag(ui_Gps_Knob_Bg, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_clear_flag(ui_GPS_Knob, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_clear_flag(ui_Distance_Group, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_set_style_bg_img_src(ui_Distance_Group, &ui_img_gps_bg_png, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_clear_flag(ui_Next_Group, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_set_style_bg_img_src(ui_Next_Group, &ui_img_gps_bg_png, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_clear_flag(ui_Next, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    ui_Image1 = lv_img_create(ui_Next_Group);
    lv_img_set_src(ui_Image1, &ui_img_right_png);
